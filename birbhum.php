...
<head>
   ...
   <title>BIRBHUM | Shop by Region | BANGLAMART Shopping Website</title>
...
<h4 class="biba1">BIRBHUM</h4>
   <div class="swiper-slide"><img src="images\pathshala-at-visva-bharai-university-campus.jpg"></div>
   ...
   <?php
    ...
    if (isset ($_GET['product_sort']))
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE `name` OR `details` LIKE '%birbhum%' order by $sort_option"); 
