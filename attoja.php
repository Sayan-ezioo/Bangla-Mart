...
<section class="products">
   ...
   <h4 class="biba1"><img src="images/Logo.png" class="img3"></h4>
   ...
   <?php
    ...
    if (isset ($_GET['product_sort']))
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE `name` OR `details` LIKE '%attoja%' order by $sort_option"); 
