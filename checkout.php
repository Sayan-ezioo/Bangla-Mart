   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" placeholder="Enter Your Phone" class="box" min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;" required>
         </div>
         <div class="inputBox">
            <span>E-mail ID :</span>
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" placeholder="e.g. Flat number/Flat Name" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
