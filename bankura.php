...
<head>
   ...
   <title>BANKURA | Shop by Region | BANGLAMART Shopping Website</title>
...
<h4 class="biba1">BANKURA</h4>
   <div class="swiper-slide"><img src="images\2020070763-1.jpg"></div>
   ...
   <?php
    ...
    if (isset ($_GET['product_sort']))
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE `name` OR `details` LIKE '%bankura%' order by $sort_option"); 
