...
<head>
   ...
   <title>NADIA | Shop by Region | BANGLAMART Shopping Website</title>
...
<h4 class="biba1">NADIA</h4>
   <div class="swiper-slide"><img src="images\tovp_surrounding__1661584076031_1661584088593_1661584088593.webp"></div>
   ...
   <?php
    ...
    if (isset ($_GET['product_sort']))
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE `name` OR `details` LIKE '%nadia%' order by $sort_option"); 
