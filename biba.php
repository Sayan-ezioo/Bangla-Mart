...
<head>
   ...
   <title>BIBA | SHOPKART Shopping Website</title>
...
<section class="products">
   ...
   <h4 class="biba1"><img src="images/Biba_logo_PNG2.png" class="img3"></h4>
   ...
   if (isset ($_GET['product_sort']))
    {
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE `name` OR `details` LIKE '%biba%' order by $sort_option"); 
