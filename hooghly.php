...
<head>
   ...
   <title>HOOGHLY | Shop by Region | BANGLAMART Shopping Website</title>
...
<h4 class="biba1">HOOGHLY</h4>
   <div class="swiper-slide"><img src="images\Howrah-Bridge-3-1.webp"></div>
   ...
   <?php
    ...
    if (isset ($_GET['product_sort']))
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE `name` OR `details` LIKE '%hooghly%' order by $sort_option"); 
