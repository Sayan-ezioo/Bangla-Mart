...
<section class="products">
   ...
   <h4 class="biba1"><img src="images/5bdfd7bd314dd83c49eada89-480x480-PhotoRoom.png-PhotoRoom.png" class="img3"></h4>
   ...
   <?php
    ...
    if (isset ($_GET['product_sort']))
     ...
     $select_products = $conn->prepare("SELECT * FROM `products` WHERE `name` OR `details` LIKE '%biswa bangla%' order by $sort_option"); 
